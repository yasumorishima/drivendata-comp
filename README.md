...
| **Colab GPU** | T4/A100 via [colab-mcp](https://github.com/googlecolab/colab-mcp) | 実験イテレーション | 1日数時間 |
...
- [ ] colab-mcp integration: Claude Code → Colab GPU direct execution for experiment iteration
